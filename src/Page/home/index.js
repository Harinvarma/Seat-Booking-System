...
import { arrangeSeat, seatArrangement, seatSpecification, } from "../../constant";
...
const Home = () => {
  ...
  useEffect(() => {
    const allSeats =
      JSON.parse(localStorage.getItem("seat")) || seatArrangement(seatSpecification.totalSeat, seatSpecification.rowLength);
    selectSeat(allSeats);
  }, []);
